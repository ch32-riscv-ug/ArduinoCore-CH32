...
- Packages the prototype platform directory as a .tar.bz2 (single root folder).
...
- Tool section: --tools github uses prototypes/index/tools_xpack_gcc.json
...
def build_archive(platform_dir: pathlib.Path, out: pathlib.Path, version: str) -> pathlib.Path:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        shutil.copytree(platform_dir, staged)
