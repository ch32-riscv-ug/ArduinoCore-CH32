 ...
 *
 * CH32V007 pin map: the union of all 4 part numbers in the
...
#define CH32_VARIANT_CH32V007 1
...
/* ---- GPIO pads: 31 in the series, 23 of them on every part ---- */
...
#if defined(ARDUINO_CH32V007E8R6) || defined(ARDUINO_CH32V007E8R7)
...
#elif defined(ARDUINO_CH32V007K8U6) || defined(ARDUINO_CH32V007K8U7)
...
#define CH32_PORT_COMMON_MASK_A 0x0000007fu
#define CH32_PORT_COMMON_MASK_B 0x0000000bu
#define CH32_PORT_COMMON_MASK_C 0x00000037u
...
/* USART2: route remap-1, on every part */
...
/* SPI1: route remap-3, on 2 of 4 parts */
#define CH32_SPI1_SCK PB1
#define CH32_SPI1_MISO PB2
#define CH32_SPI1_MOSI PC0
#define CH32_SPI1_CLKEN_ADDR 0x40021018u
#define CH32_SPI1_CLKEN_MASK 0x00001000u
#define CH32_SPI1_REMAP_MASK 0x00000007u
#define CH32_SPI1_REMAP_VAL  0x00000003u
