 ...
 *
 * CH32V203 pin map: the union of all 12 part numbers in the
...
#define CH32_CLKEN_BLE_CRC_ADDR 0x40021014u
#define CH32_CLKEN_BLE_CRC_MASK 0x00030040u
...
#if defined(ARDUINO_CH32V203C6T6) || defined(ARDUINO_CH32V203C6U6) || defined(ARDUINO_CH32V203C8T6) || defined(ARDUINO_CH32V203C8U6)
...
#elif defined(ARDUINO_CH32V203F6P6)
#define CH32_PORT_MASK_A 0x000078ffu
#define CH32_PORT_MASK_B 0x00000102u
#define CH32_PORT_MASK_C 0x00000000u
#define CH32_PORT_MASK_D 0x00000000u
#elif defined(ARDUINO_CH32V203F8P6)
#define CH32_PORT_MASK_A 0x000067ffu
#define CH32_PORT_MASK_B 0x0000e0c1u
#define CH32_PORT_MASK_C 0x00000000u
#define CH32_PORT_MASK_D 0x00000000u
#elif defined(ARDUINO_CH32V203F8U6)
#define CH32_PORT_MASK_A 0x00007fffu
#define CH32_PORT_MASK_B 0x0000cc03u
#define CH32_PORT_MASK_C 0x00000000u
#define CH32_PORT_MASK_D 0x00000000u
#elif defined(ARDUINO_CH32V203G6U6)
#define CH32_PORT_MASK_A 0x0000feffu
#define CH32_PORT_MASK_B 0x000001fbu
#define CH32_PORT_MASK_C 0x00000000u
#define CH32_PORT_MASK_D 0x00000000u
#elif defined(ARDUINO_CH32V203G8R6)
#define CH32_PORT_MASK_A 0x00007fffu
#define CH32_PORT_MASK_B 0x0000fde3u
#define CH32_PORT_MASK_C 0x00000000u
#define CH32_PORT_MASK_D 0x00000000u
#elif defined(ARDUINO_CH32V203K8T6)
#define CH32_PORT_MASK_A 0x0000ffffu
#define CH32_PORT_MASK_B 0x000001fbu
#define CH32_PORT_MASK_C 0x00000000u
#define CH32_PORT_MASK_D 0x00000000u
#elif defined(ARDUINO_CH32V203K8U7)
#define CH32_PORT_MASK_A 0x0000ffffu
#define CH32_PORT_MASK_B 0x000083ffu
#define CH32_PORT_MASK_C 0x0000c000u
#define CH32_PORT_MASK_D 0x00000000u
#elif defined(ARDUINO_CH32V203RBT6)
#define CH32_PORT_MASK_A 0x0000ffffu
#define CH32_PORT_MASK_B 0x0000ffffu
...
/* USART1: route default, on 11 of 12 parts */
...
/* USART3: route default, on 6 of 12 parts */
...
/* I2C1: route default, on 10 of 12 parts */
...
/* I2C2: route default, on 6 of 12 parts */
...
/* SPI2: route default, on 5 of 12 parts */
