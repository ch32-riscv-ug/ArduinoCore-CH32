...
#define CH32_CLKEN_ETH_MAC_Rx_ADDR 0x40021014u
#define CH32_CLKEN_ETH_MAC_Rx_MASK 0x00010000u
#define CH32_CLKEN_ETH_MAC_Tx_ADDR 0x40021014u
#define CH32_CLKEN_ETH_MAC_Tx_MASK 0x00008000u
...
#define CH32_CLKEN_UART6_ADDR 0x4002101cu
#define CH32_CLKEN_UART6_MASK 0x00000040u
#define CH32_CLKEN_UART7_ADDR 0x4002101cu
#define CH32_CLKEN_UART7_MASK 0x00000080u
#define CH32_CLKEN_UART8_ADDR 0x4002101cu
#define CH32_CLKEN_UART8_MASK 0x00000100u
...
/* ---- GPIO pads: 80 in the series, 35 of them on every part ---- */
...
#if defined(ARDUINO_CH32V303CBT6)
...
#elif defined(ARDUINO_CH32V303RBT6) || defined(ARDUINO_CH32V303RCT6) || defined(ARDUINO_CH32V303RCT7)
#define CH32_PORT_MASK_A 0x0000ffffu
#define CH32_PORT_MASK_B 0x0000ffffu
#define CH32_PORT_MASK_C 0x0000ffffu
#define CH32_PORT_MASK_D 0x00000004u
#define CH32_PORT_MASK_E 0x00000000u
#elif defined(ARDUINO_CH32V303VCT6)
#define CH32_PORT_MASK_A 0x0000ffffu
#define CH32_PORT_MASK_B 0x0000ffffu
#define CH32_PORT_MASK_C 0x0000ffffu
...
/* device-data lists PA15, PB5 for MOSI on this route;
...
#define CH32_TIMER_TABLE(X) \
    ...
    X(4, 2, 16, 4, 0, CH32_TIM4_BASE, 0x4002101cu, 0x00000004u, CH32_IRQN_TIM4, TIM4_IRQHandler) \
    X(5, 2, 32, 4, 0, CH32_TIM5_BASE, 0x4002101cu, 0x00000008u, CH32_IRQN_TIM5, TIM5_IRQHandler) \
